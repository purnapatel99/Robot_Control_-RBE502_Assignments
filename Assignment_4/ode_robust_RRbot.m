function [dz] = ode_robust_RRbot(t, z, k, P, p, B, phi)

dz = zeros (6,1);
z = num2cell(z);

[th1, th2, dth1, dth2,T1,T2] = deal(z{:});
...
%These are he nomonal values of the parameters
...
Mmat= [a+2*b*cos(th2), d+b*cos(th2); d+b*cos(th2), d];
Cmat= [-b*sin(th2)*dth2, -b*sin(th2)*(dth1+dth2); b*sin(th2)*dth1,0];
Gmat= [-m1*g*r1*sin(th1)-m2*g*(l1*sin(th1)+r2*sin(th1+th2)); -m2*g*r2*sin(th1+th2)];


T = Mmat*v+Cmat*[dth1; dth2]+Gmat;
    
%%
%Again defining the original values for the simulation
